...
#' @param path_lengths Optional data.frame with columns "path_count", "PathName",'length', "Jminus", and "Jplus" defining the road length of each path and space between previous and next path, in meters.
...
Write_AHI_template <- function(input_data, n_frequency = 1, major_paths = NULL, WADT = 7000,
                             ...
                             path_lengths = NULL, outputPath, wait_time = 1, Ps = 0.05, Ps_prime = 0.3, Lave_light = 0.3,
